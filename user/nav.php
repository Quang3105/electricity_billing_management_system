...
<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
    ...
    <ul class="nav navbar-right top-nav" style="margin-right: 10px">
        <li class="dropdown">
            <?php 
                echo "<a style='font-size:16px' class='dropdown-toggle' data-toggle='dropdown'><i class='fa fa-user'></i> $user <b class=\"caret\"></b></a> ";
             ?>
            <ul class="dropdown-menu">
                <li>
                    <a href="#" data-toggle="modal" data-target="#profile"><i class="fa fa-fw fa-user"></i> Thông tin cá nhân</a>
                </li>
    ...
    <div class="modal-dialog modal-sm">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h3 class="modal-title"><b><i class="fa fa-fw fa-user"></i>Thông tin cá nhân</b></h3>
            </div>
        <div class="modal-body text-center">
            <h4>Tên: <code><?php echo $row['name'] ?></code></h4>
            <h4>Email: <code><?php echo $row['email'] ?></code></h4>
            <h4>Ngày sinh: <code><?php echo $row['birthday'] ?></code></h4>
            <h4>SĐT: <code><?php echo $row['phone'] ?></code></h4>
            <h4>Địa chỉ: <code><?php echo $row['address'] ?></code></h4>
        </div>
        </div><!-- /.modal-content -->
    </div><!-- /.modal-dialog -->
</div><!-- /.modal -->      
